...
import IronDocuments, { SemanticChunk, ProgressInfo } from '../irondocuments';
...
export class PDFWebSocketProcessor {
    ...
    private async processChunksRealTime(pdf: IronDocuments): Promise<void> {
    ...
    private async getFinalAnalysis(pdf: IronDocuments): Promise<{ documentType: string; keyInsights: string[] }> {
        try {
