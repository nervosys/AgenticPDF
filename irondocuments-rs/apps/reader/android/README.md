...
`irondocuments-rs/.cargo/config.toml`; the NDK's clang wrappers already know their
...
- The three `.so` files link and export the six `Java_ai_nervosys_irondoc_Reader_*`
