...
use irondocuments::adf::oplog::OpId;
use irondocuments::doc::Block;
...
fn parse_markdown_blocks(markdown: &str) -> Vec<Block> {
    irondocuments::formats::text::parse_markdown(markdown.as_bytes())
        .sections
        .into_iter()
...
"
    ...
    fn capabilities_answers_without_a_document() {
        ...
        assert_eq!(result["application"], "irondoc-reader");
    }
