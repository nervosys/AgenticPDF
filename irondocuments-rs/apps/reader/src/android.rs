...
#[unsafe(no_mangle)]
pub extern "system" fn Java_ai_nervosys_irondoc_Reader_nativeOpen(
    env: JNIEnv,
    _class: JClass,
    data: JByteArray,
) -> jstring {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_ai_nervosys_irondoc_Reader_nativeExecute(
    mut env: JNIEnv,
    _class: JClass,
    action: JString,
    params: JString,
...
/// an Android `Canvas`.
#[unsafe(no_mangle)]
pub extern "system" fn Java_ai_nervosys_irondoc_Reader_nativeRenderPage(
    env: JNIEnv,
    _class: JClass,
    width: jfloat,
    height: jfloat,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_ai_nervosys_irondoc_Reader_nativeSave(
    env: JNIEnv,
    _class: JClass,
) -> jbyteArray {
    let result = catch_unwind(AssertUnwindSafe(|| {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_ai_nervosys_irondoc_Reader_nativeIsDirty(
    _env: JNIEnv,
    _class: JClass,
) -> jboolean {
    let dirty = SESSION
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_ai_nervosys_irondoc_Reader_nativeCapabilities(
    env: JNIEnv,
    _class: JClass,
) -> jstring {
