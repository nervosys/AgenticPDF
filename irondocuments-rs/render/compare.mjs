...
//   node irondocuments-rs/render/compare.mjs [pages...]   (default: 1 5 6)
...
const OUT = path.join(ROOT, "irondocuments-rs", "render", "cmp");
...
const url = `http://localhost:${server.address().port}/irondocuments-rs/render/compare.html`;
