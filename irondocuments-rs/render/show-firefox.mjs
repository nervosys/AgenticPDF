...
// IronDocuments WebGL2 renderer, and keep it open. Run:
//   node irondocuments-rs/render/show-firefox.mjs
...
const url = `http://localhost:${server.address().port}/irondocuments-rs/render/viewer.html`;
