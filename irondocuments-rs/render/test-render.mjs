...
// and asserts content was drawn. Run: node irondocuments-rs/render/test-render.mjs
...
const url = `http://localhost:${server.address().port}/irondocuments-rs/render/harness.html`;
...
async function run(launch, name, opts) {
  ...
  try {
    ...
    await page.screenshot({ path: path.join(ROOT, `irondocuments-rs/render/out-${name}.png`) });
