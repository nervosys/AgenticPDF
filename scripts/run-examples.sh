#!/bin/bash
# IronDocuments Examples Runner for Unix/Linux/macOS
# This shell script provides easy access to run IronDocuments examples
...
show_header() {
    echo
    print_colored $CYAN "===================================="
    print_colored $CYAN "    IronDocuments Examples Runner"
    print_colored $CYAN "===================================="
    echo
}
...
if [ $exit_code -ne 0 ]; then
    ...
    print_colored $GREEN "================================"
    echo
    print_colored $CYAN "🎉 Great job! You've successfully run the IronDocuments examples."
