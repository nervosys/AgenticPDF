# IronDocuments Testing Suite

## Overview

This directory contains a comprehensive testing suite for the IronDocuments library, designed to ensure reliability, performance, and correctness across all features and edge cases.
...
└── integration/           # Integration tests
    └── IronDocuments.test.ts  # Main class integration tests
```
...
```bash
# Main IronDocuments class integration
npm test integration/IronDocuments.test.ts
```
...
4. **Test error conditions**:
   ...
   test('should handle invalid PDF header', async () => {
     ...
     await expect(IronDocuments.fromBuffer(invalidPDF.buffer))
...
This comprehensive testing suite ensures IronDocuments maintains high quality and reliability across all supported features and use cases.
