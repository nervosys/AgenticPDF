/**
 * Integration tests for the main IronDocuments class
...
describe('IronDocuments Main Class Integration', () => {
    ...
    describe('Error Recovery and Resilience', () => {
        test('should handle partial PDF loading', async () => {
            ...
            try {
                const pdf = await IronDocuments.fromBuffer(partialPDFData.buffer as ArrayBuffer);
                expect(pdf).toBeDefined();
                pdf.close();
            } catch (error) {
                expect(error).toBeInstanceOf(Error);
