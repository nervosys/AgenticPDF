...
import { IronDocuments, EmbeddingProvider } from '../../irondocuments';
...
describe('AI Features and Semantic Analysis', () => {
    ...
    describe('Document Structure Analysis', () => {
        ...
        test('should extract key entities', () => {
            const entities = {
                ...
                organizations: ['IronDocuments', 'Test Corp'],
    ...
    describe('Summarization and Generation', () => {
        ...
        test('should extract key sentences', () => {
            const keySentences = [
                {
                    sentence: 'The IronDocuments library follows a streaming-first architecture.',
                    importance: 0.95,
                    position: 1.2,
                    pageNumber: 1,
                },
    ...
    describe('Advanced AI Features', () => {
        test('should perform question-answering on document content', () => {
            const qa = {
                question: 'What is the main purpose of the IronDocuments library?',
