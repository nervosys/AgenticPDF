/**
 * Comprehensive error handling tests for IronDocuments
...
describe('IronDocuments Error Handling', () => {
    beforeEach(() => {
    ...
    describe('Malformed PDF Errors', () => {
        test('should handle invalid PDF header', async () => {
            ...
            await expect(async () => {
                const pdf = await IronDocuments.fromBuffer(invalidPDF.buffer as ArrayBuffer);
                pdf.close();
            }).rejects.toThrow();
        });
        ...
        test('should handle corrupted PDF structure', async () => {
            ...
            try {
                const pdf = await IronDocuments.fromBuffer(corruptedPDF.buffer as ArrayBuffer);
        ...
        test('should handle missing xref table', async () => {
            ...
            try {
                const pdf = await IronDocuments.fromBuffer(noxrefPDF.buffer as ArrayBuffer);
                pdf.close();
            } catch (error) {
                expect(error).toBeInstanceOf(Error);
        ...
        test('should handle encrypted PDF without password', async () => {
            ...
            try {
                const pdf = await IronDocuments.fromBuffer(encryptedPDF.buffer as ArrayBuffer);
        ...
        test('should handle PDF with invalid objects', async () => {
            ...
            try {
                const pdf = await IronDocuments.fromBuffer(invalidObjectsPDF.buffer as ArrayBuffer);
        ...
        test('should handle truncated PDF file', async () => {
            ...
            try {
                const pdf = await IronDocuments.fromBuffer(truncatedPDF.buffer as ArrayBuffer);
    ...
    describe('Memory and Resource Limits', () => {
        test('should handle memory limit exceeded', async () => {
            ...
            try {
                const pdf = await IronDocuments.fromBuffer(largePDF.buffer as ArrayBuffer, options);
        ...
        test('should handle worker thread failure', async () => {
            ...
            try {
                const pdfData = Mocks.MockPDFGenerator.createSimplePDF();
                const pdf = await IronDocuments.fromBuffer(pdfData.buffer as ArrayBuffer, options);
        ...
        test('should handle stream backpressure', async () => {
            ...
            try {
                const pdf = IronDocuments.fromStream(slowStream);
    ...
    describe('Content Extraction Errors', () => {
        test('should handle corrupted text encoding', async () => {
            ...
            try {
                const pdf = await IronDocuments.fromBuffer(pdfWithBadEncoding.buffer as ArrayBuffer);
        ...
        test('should handle missing fonts', async () => {
            ...
            try {
                const pdf = await IronDocuments.fromBuffer(pdfWithMissingFonts.buffer as ArrayBuffer);
        ...
        test('should handle invalid image data', async () => {
            ...
            try {
                const pdf = await IronDocuments.fromBuffer(pdfWithBadImages.buffer as ArrayBuffer);
    ...
    describe('Stream and Async Operation Errors', () => {
        test('should handle stream abortion', async () => {
            ...
            try {
                const pdf = IronDocuments.fromStream(stream);
